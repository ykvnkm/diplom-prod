...
if [[ "${REQUIRE_YOLO_ONNX:-0}" == "1" ]]; then
  YOLO_ONNX_TARGET="${YOLO_ONNX_PATH:-/app/models/yolov8n_baseline_multiscale.onnx}"
  YOLO_ONNX_URL="${YOLO_ONNX_URL:-}"
  fetch_if_missing "$YOLO_ONNX_TARGET" "$YOLO_ONNX_URL"
fi
