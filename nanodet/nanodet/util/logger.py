...
import numpy as np
try:
    from lightning_fabric.utilities.cloud_io import get_filesystem  # type: ignore
    from pytorch_lightning.loggers import Logger as LightningLoggerBase  # type: ignore
    from pytorch_lightning.loggers.logger import rank_zero_experiment  # type: ignore
    from pytorch_lightning.utilities import rank_zero_only  # type: ignore
except Exception:  # noqa: BLE001
    def get_filesystem(_path):  # type: ignore
        class _FS:
    ...
    def rank_zero_experiment(fn):  # type: ignore
        return fn

    rank_zero_only = _RankZeroOnly()  # type: ignore
    LightningLoggerBase = object  # type: ignore
